...
def generador_controlador(Nivel_Actual, Nivel_Inferior, Nivel_Superior):
    f = open('../Deploy_Files/' + Nivel_Actual[0] + '_controller_deployment.yaml', 'w')
...
def addHigherLevelToApplication(Nivel_Superior, genericLevelsRequired):
    f_default = open('../Deploy_Files/default-app-controller-deployment.yaml', 'r')
    ...
    f = open('../Deploy_Files/application-controller-deployment.yaml', 'w')
...
def generador_permisos(Nivel_Actual, Nivel_Inferior, Nivel_Superior):
    f1 = open('../Deploy_Files/RBAC_files/' + Nivel_Actual[0] + '_controller_role.yaml', 'w')
    f2 = open('../Deploy_Files/RBAC_files/' + Nivel_Actual[0] + '_controller_rolebinding.yaml', 'w')
    f3 = open('../Deploy_Files/RBAC_files/' + Nivel_Actual[0] + '_controller_serviceaccount.yaml', 'w')
...
def generador_permisos_ultimo_nivel():
    ...
    f_comp1 = open('../Deploy_Files/RBAC_files/component_controller_role.yaml', 'w')
    f_comp2 = open('../Deploy_Files/RBAC_files/component_controller_rolebinding.yaml', 'w')
    f_comp3 = open('../Deploy_Files/RBAC_files/component_controller_serviceaccount.yaml', 'w')
